    ...
    <section id="hero-26" class="bg--scroll hero-section">
        <div class="container">
            <div class="row d-flex align-items-center">
                <!-- HERO TEXT -->
                <div class="col-md-6">
                    <div class="hero-26-txt color--white wow fadeInLeft">
                        <!-- Title -->
                ...
                <!-- HERO IMAGE -->
                <div class="col-md-6">
                    <div class="hero-26-img wow fadeInRight">
                        <img class="img-fluid" loading="lazy" src="/assets/images/hero-26-img.png" alt="hero-image" />
                    </div>
                </div>
            </div>
            <!-- End row -->

                    ...
                    <div class="fbox-12 bg--black-300 r-28 nav-cards wow animated" data-animation="fadeInLeft">
                        <div class="exbox active">
                            ...
                            <p class="s-14 text-white">
                                Enhancing the effectiveness <br> and reach of professional <br> efforts.
                            </p>
                        </div>

                        <div class="exbox">
                            <h4 class="s-16 w-700 text-white mb-2">Strategic Allocation:</h4>
                        ...
                        <div class="exbox">
                            <h4 class="s-16 w-700 text-white mb-2">Customized Approach:</h4>

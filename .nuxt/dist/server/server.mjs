...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-0c6c82c7.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-6094b5a0.js").then((m) => m.default || m),
  "footer-2": () => import("./_nuxt/footer-2-c5cdb657.js").then((m) => m.default || m),
  "no-header-footer": () => import("./_nuxt/no-header-footer-f82125a7.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-52507e75.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
